...
return [
    ...
    "messages" => [
        ...
        "Tracks user page views" => "Трекает просмотр страниц пользователем",
        "Tracks changes in the cart (adding/removing items)" => "Трекает изменения в корзине (добавление/удаление товара)",
        "Tracks when the user opens the cart" => "Трекает момент, когда пользователь открыл корзину",
