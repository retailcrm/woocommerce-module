...
return [
    ...
    "messages" => [
        ...
        "Phone number: " => "Привязанный телефон: ",
        "Total order summ: " => "Сумма покупок за все время: ",
        "Total summ for next level: " => "Сумма, оставшаяся для перехода на следующий уровень: ",
